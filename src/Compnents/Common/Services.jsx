...
const ServiceCard = ({ service }) => {
  return (
    <div className=" transition-all text-customColor duration-200 hover:-translate-y-1.5 shadow-blue-500/50  w-[90vw] lg:w-[22vw] h-[60vh] rounded-md service-card  bg-white p-4 ">
