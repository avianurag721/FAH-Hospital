...
const Poster2 = () => {
  return (
    <div className="relative bg-white  text-black flex flex-col items-center justify-center">
      <div className=" absolute top-5  text-black flex flex-col items-center justify-center">
